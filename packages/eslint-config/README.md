...
```shell
npm i -D zj-eslint-config @babel/core @babel/eslint-parser eslint-plugin-import
```
...
```shell
npm i -D zj-eslint-config @babel/core @babel/eslint-parser eslint-plugin-import eslint-plugin-react eslint-plugin-react-hooks
```
...
```json
{
  "extends": ["zj-eslint-config/react"]
}
```
...
```shell
npm i -D zj-eslint-config @typescript-eslint/parser @typescript-eslint/eslint-plugin eslint-plugin-import eslint-import-resolver-typescript
```
...
```json
{
  "extends": ["zj-eslint-config/typescript"]
}
```
...
```
npm i -D zj-eslint-config @typescript-eslint/parser @typescript-eslint/eslint-plugin eslint-plugin-import eslint-import-resolver-typescript eslint-plugin-react eslint-plugin-react-hooks
```
...
```json
{
  "extends": ["zj-eslint-config/typescript/react"]
}
```
