...
export default {
  plugins: {
    typescript_eslint: tsEslint.plugin,
  },
  languageOptions: {
  ...
  rules: {
     ...
     */
    'typescript_eslint/adjacent-overload-signatures': 'error',
     ...
     */
    'typescript_eslint/array-type': ['warn', {default: 'array-simple'}],
     ...
     */
    'typescript_eslint/await-thenable': 'off',
     ...
     */
    'typescript_eslint/ban-ts-comment': [
      'warn',
      {
     ...
     */
    'typescript_eslint/class-literal-property-style': ['warn', 'fields'],
     ...
     */
    'comma-spacing': 'off',
    'typescript_eslint/comma-spacing': [
      'error',
     ...
     */
    'typescript_eslint/consistent-type-assertions': [
      'error',
      {
        assertionStyle: 'as',
     ...
     */
    'typescript_eslint/consistent-type-definitions': ['warn', 'interface'],
    ...
    'typescript_eslint/default-param-last': 'off',
     ...
     */
    'dot-notation': 'off',
    'typescript_eslint/dot-notation': ['error', {allowKeywords: true}],
     ...
     */
    'typescript_eslint/explicit-member-accessibility': [
      'warn',
     ...
     */
    'typescript_eslint/explicit-module-boundary-types': 'off',
    ...
    'typescript_eslint/func-call-spacing': ['error', 'never'],
    ...
    'typescript_eslint/init-declarations': 'off',
     ...
     */
    'keyword-spacing': 'off',
    'typescript_eslint/keyword-spacing': [
      'error',
      {
        before: true,
        after: true,
    ...
    'typescript_eslint/lines-between-class-members': 'off',
     ...
     */
    'typescript_eslint/member-delimiter-style': 'error',
     ...
     */
    'typescript_eslint/member-ordering': [
      'warn',
      {
        default: [
          'public-static-field',
     ...
     */
    'typescript_eslint/method-signature-style': ['warn', 'property'],
     ...
     */
    camelcase: 'off',
    'typescript_eslint/camelcase': 'off',
    'typescript_eslint/naming-convention': 'off',
    ...
    'typescript_eslint/no-array-constructor': 'error',
     ...
     */
    'typescript_eslint/no-base-to-string': 'off',
     ...
     */
    'typescript_eslint/no-confusing-non-null-assertion': 'warn',
    ...
    'typescript_eslint/no-dupe-class-members': 'error',
     ...
     */
    'typescript_eslint/no-dynamic-delete': 'off',
    ...
    'typescript_eslint/no-empty-function': [
      'error',
      {
     ...
     */
    'typescript_eslint/no-empty-interface': 'warn',
     ...
     */
    'typescript_eslint/no-extra-non-null-assertion': 'off',
     ...
     */
    'no-extra-parens': 'off',
    'typescript_eslint/no-extra-parens': 'off',
     ...
     */
    'no-extra-semi': 'off',
    'typescript_eslint/no-extra-semi': 'error',
     ...
     */
    'typescript_eslint/no-extraneous-class': 'off',
     ...
     */
    'typescript_eslint/no-floating-promises': 'off',
     ...
     */
    'typescript_eslint/no-for-in-array': 'off',
     ...
     */
    'typescript_eslint/no-implied-eval': 'off',
     ...
     */
    'typescript_eslint/no-inferrable-types': 'warn',
     ...
     */
    'no-invalid-this': 'off',
    'typescript_eslint/no-invalid-this': 'off',
     ...
     */
    'typescript_eslint/no-invalid-void-type': 'error',
    
    // typescript_eslint/no-loss-of-precision needs eslint version >= v7
    ...
    'typescript_eslint/no-magic-numbers': 'off',
    
    /**
     * 【关闭】禁止在接口中定义 constructor，或在类中定义 new
     */
    'typescript_eslint/no-misused-new': 'off',
    
    /**
     * 【关闭】避免错误的使用 Promise
     */
    'typescript_eslint/no-misused-promises': 'off',
    
    /**
     * 【强制】禁止使用 namespace 来定义命名空间，但允许使用 declare namespace 定义外部命名空间
     */
    'typescript_eslint/no-namespace': [
      'error',
      {
     ...
     */
    'typescript_eslint/no-non-null-asserted-optional-chain': 'error',
    
    /**
     * 【关闭】禁止使用 non-null 断言（感叹号）
     */
    'typescript_eslint/no-non-null-assertion': 'off',
    
    /**
     * 【关闭】禁止给类的构造函数的参数添加修饰符
     */
    'typescript_eslint/no-parameter-properties': 'off',
    
    /**
     * 【推荐】不建议使用 require 引入模块，使用 import
     */
    'typescript_eslint/no-require-imports': 'warn',
     ...
     */
    'no-shadow': 'off',
    'typescript_eslint/no-shadow': 'error',
    
    /**
     * 【推荐】不建议将 this 赋值给其他变量，解构赋值除外
     */
    'typescript_eslint/no-this-alias': [
      'warn',
      {
     ...
     */
    'typescript_eslint/no-throw-literal': 'off',
    
    /**
     * 【关闭】禁止使用类型别名
     */
    'typescript_eslint/no-type-alias': 'off',
    
    /**
     * 【关闭】测试表达式中的布尔类型禁止与 true 或 false 直接比较
     */
    'typescript_eslint/no-unnecessary-boolean-literal-compare': 'off',
    
    /**
     * 【关闭】条件表达式禁止是永远为真（或永远为假）的
     */
    'typescript_eslint/no-unnecessary-condition': 'off',
    
    /**
     * 【关闭】在命名空间中，可以直接使用内部变量，不需要添加命名空间前缀
     */
    'typescript_eslint/no-unnecessary-qualifier': 'off',
    
    /**
     * 【关闭】禁止范型的类型有默认值时，将范型设置为该默认值
     */
    'typescript_eslint/no-unnecessary-type-arguments': 'off',
    
    /**
     * 【关闭】禁止无用的类型断言
     */
    'typescript_eslint/no-unnecessary-type-assertion': 'off',
    
    /**
     * 【关闭】禁止将变量或属性的类型设置为 any
     */
    'typescript_eslint/no-unsafe-assignment': 'off',
    
    /**
     * 【关闭】禁止调用 any 类型的变量上的方法
     */
    'typescript_eslint/no-unsafe-call': 'off',
    
    /**
     * 【关闭】禁止获取 any 类型的变量中的属性
     */
    'typescript_eslint/no-unsafe-member-access': 'off',
    
    /**
     * 【关闭】禁止函数的返回值的类型是 any
     */
    'typescript_eslint/no-unsafe-return': 'off',
    ...
    'typescript_eslint/no-unused-expressions': [
      'error',
      {
     ...
     * 【关闭】禁止已定义的变量未使用
     */
    'typescript_eslint/no-unused-vars-experimental': 'off',
    ...
    'typescript_eslint/no-use-before-define': [
      'error',
    ...
    'typescript_eslint/no-useless-constructor': 'error',
    
    /**
     * 【关闭】禁止使用 require 来引入模块，被 no-require-imports 规则包含
     */
    'typescript_eslint/no-var-requires': 'off',
    
    /**
     * 【推荐】当设定当前值为当前类型时，推荐使用 as const 替代 as 'bar'
     */
    'typescript_eslint/prefer-as-const': 'warn',
    
    /**
     * 【关闭】如果索引仅用于访问正在迭代的数组，则建议首选 for of 循环，而不是标准 for 循环
     */
    'typescript_eslint/prefer-for-of': 'off',
    
    /**
     * 【关闭】可以简写为函数类型的接口或对象字面类型的话，则必须简写
     */
    'typescript_eslint/prefer-function-type': 'off',
    
    /**
     * 【关闭】使用 includes 而不是 indexOf
     */
    'typescript_eslint/prefer-includes': 'off',
    
    /**
     * 【强制】禁止使用 module 来定义命名空间，declare module 是允许的
     */
    'typescript_eslint/prefer-namespace-keyword': 'error',
    
    /**
     * 【关闭】使用 ?? 替代 ||
     */
    'typescript_eslint/prefer-nullish-coalescing': 'off',
    
    /**
     * 【关闭】使用 optional chaining 替代 &&
     * 由于对 ts 版本有要求，暂不开启
     */
    'typescript_eslint/prefer-optional-chain': 'off',
    
    /**
     * 【关闭】私有变量如果没有在构造函数外被赋值，则必须设为 readonly
     */
    'typescript_eslint/prefer-readonly': 'off',
    
    /**
     * 【关闭】函数的参数必须设置为 readonly
     */
    'typescript_eslint/prefer-readonly-parameter-types': 'off',
    
    /**
     * 【关闭】使用 reduce 方法时，必须传入范型，而不是对第二个参数使用 as
     */
    'typescript_eslint/prefer-reduce-type-parameter': 'off',
    
    /**
     * 【关闭】使用 RegExp#exec 而不是 String#match
     */
    'typescript_eslint/prefer-regexp-exec': 'off',
    
    /**
     * 【关闭】使用 String#startsWith 而不是其他方式
     */
    'typescript_eslint/prefer-string-starts-ends-with': 'off',
    
    /**
     * 【关闭】当需要忽略下一行的 ts 错误时，必须使用 @ts-expect-error 而不是 @ts-ignore
     */
    'typescript_eslint/prefer-ts-expect-error': 'off',
    
    /**
     * 【关闭】async 函数的返回值必须是 Promise
     */
    'typescript_eslint/promise-function-async': 'off',
    
    /**
     * 【强制】ts 文件字符串字面量优先使用单引号
     */
    quotes: 'off',
    'typescript_eslint/quotes': ['error', 'single', {avoidEscape: true}],
    
    /**
     * 【关闭】async 函数中必须存在 await 语句
     */
    'require-await': 'off',
    'typescript_eslint/require-await': 'off',
    
    /**
     * 【推荐】使用加号时，两者必须同为数字或同为字符串
     */
    'typescript_eslint/restrict-plus-operands': 'warn',
    
    /**
     * 【关闭】模版字符串中的变量类型必须是字符串
     */
    'typescript_eslint/restrict-template-expressions': 'off',
     ...
     */
    'no-return-await': 'off',
    'typescript_eslint/return-await': 'off',
     ...
     */
    semi: 'off',
    'typescript_eslint/semi': ['error', 'always'],
    ...
    'typescript_eslint/space-before-function-paren': [
      'error',
      {
        anonymous: 'always',
        named: 'never',
     ...
     * 【关闭】条件判断必须传入布尔值
     */
    'typescript_eslint/strict-boolean-expressions': 'off',
    
    /**
     * 【关闭】使用联合类型作为 switch 的对象时，必须包含每一个类型的 case
     */
    'typescript_eslint/switch-exhaustiveness-check': 'off',
    
    /**
     * 【强制】三斜杠导入语法已废弃，在非 dts 文件中禁止使用
     */
    'typescript_eslint/triple-slash-reference': [
      'error',
      {
        path: 'never',
        types: 'always',
     ...
     * 【强制】定义类型时应正确添加空格
     */
    'typescript_eslint/type-annotation-spacing': 'error',
    
    /**
     * 【强制】interface 和 type 定义时必须声明成员的类型
     */
    'typescript_eslint/typedef': [
      'error',
      {
     ...
     */
    'typescript_eslint/unbound-method': 'off',
    
    /**
     * 【推荐】定义函数时，优先使用参数的联合类型而不是函数的类型重载
     */
    'typescript_eslint/unified-signatures': 'warn',
     ...
     */
    'no-redeclare': 'off',
    'typescript_eslint/no-redeclare': ['error'],
  }
};
